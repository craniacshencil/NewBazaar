...
# content
finalsold = st.number_input(
    f"""Enter the final selling price of your {car['Myear']} {
        car['Brand']} {car['Model']} {car['Variant']}""",
    value=None,
    placeholder="Enter price in Lakh",
)
st.info("This is a compulsory field")
dummy = st.columns(7)[3].button(
    label="Confirm Price", use_container_width=True)
if dummy:
    if finalsold != None:
