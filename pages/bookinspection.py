...
with stylable_container(
    ...
    with col1:
        colored_header(
            label="Benefits of having your car inspected: ",
            color_name="red-70",
            description="",
        )
        st.write(" ")
        st.markdown(
            "##### - Thorough Inspection: Your car will be comprehensively inspected by trained professionals \
                covering various aspects, including the engine, transmission, brakes, suspension and more"
        )
        st.write(" ")
        st.markdown(
            "##### - Quality Assurance: Approved cars are assured, thoroughly checked and do not have any major issues."
        )
        st.write("")
